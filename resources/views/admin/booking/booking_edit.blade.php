...
<li class=""><img src="{{ URL::asset('img/user.png') }}" class="mr-2" /> 12</li>
<li class=""><img src="{{ URL::asset('img/img2.png') }}" /> H-1 <img src="{{ URL::asset('img/redplus.png') }}" /></li>
<li class="pt-3">Ms Jenifer Lo</li>
<li class=""><img src="{{ URL::asset('img/notes.png') }}" class="mr-2" /> Notes</li>
...
<a href="#"><img src="img/cancelblack.png" class="imgfooter" /></a>
<a href="#"><img src="img/applyred.png" class="imgfooter" /></a>
