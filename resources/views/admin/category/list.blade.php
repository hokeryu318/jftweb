        ...
        <div class="pt-5">
            ...
            <div class="col-12">
                <div class="d-inline-block text-white font-bold border-blue ">
                    <a href="#" class="text-white d-inline-block border-rightBlue p-3 w-60px">DISH</a><a class="text-white p-3 d-inline-block border-rightBlue w-60px bg-blue2" href="#">CATEGORY</a><a class="text-white p-3 d-inline-block  border-rightBlue w-60px" href="#">OPTION</a><a class="text-white p-3 d-inline-block border-rightBlue  w-60px" href="#">DISCOUNT</a>
                </div>
