<div class="tip_modal">
    <div class="row" style="margin: 0 0 10px 50px;">
        <span style="color: white;font-weight: 500;font-size: 30px;margin: 4px 10px 0 0;">Discount:</span>
        <span style="background: white;">
            <input id="discount" name="discount" value="" style="font-size: 30px;text-align: right;border-style: solid;border-width: 1px;width: 200px;" disabled />
        </span>
    </div>
    <div class="row">
        ...
        <table style="border-spacing: 10px;border-collapse: separate;margin:0 0 0 75px;">
            ...
            <tr>
                ...
                <td class="number_panel" style="background: #D8D8D8;color:black" onclick="onNumber_dis(0)"><span class="fs-35">0</span></td>
