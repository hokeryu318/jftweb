...
<div class="col-9 pl-0">
    ...
    <form action="<?php echo e(route('admin.setting.activebadge')); ?>" method="POST" id="active_form">
    <?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card pt-4 pb-2" style="margin-bottom:10px">
        <div class="row">
            <div class="col-6">
                <h6 class="font-weight-bold pl-5"><?php echo e($badge->name); ?></h6>
            </div>
            <div class="col-3 text-center">
                <img class="" src="<?php echo e(asset('badges/'.$badge->filepath)); ?>" width="30px" />
            </div>
            <div class="col-3 text-center">
                <label class="switch-style">
                    <input type="checkbox" name="actives[]" value="<?php echo e($badge->id); ?>"
                    <?php if($badge->active == 1): ?>
                    checked
                    <?php endif; ?>
                    >
    ...
    <form action="<?php echo e(route('admin.setting.addbadge')); ?>" method="POST" id="image_form" enctype='multipart/form-data'>
