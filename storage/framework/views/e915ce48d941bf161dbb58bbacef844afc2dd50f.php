...
<div class="container-fluid pb-5 blackgrey">
    ...
    <div class="popupchangePhoto white" id="popupchangePhoto">
        <div class="row">
            <div class="col-12">
                <a>
                    <span class="">
                        <img src="<?php echo e(asset('img/Group1100.png')); ?>" height="20" id="btncloselang" class="float-right mr-3 mt-2" width="20" />
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="widthh pb-2 pt-3 white">
        <div class="row">
            <div class="col-12">
                <a><span class="">
                       <img src="<?php echo e(asset('img/Group1100.png')); ?>" height="18" class="float-right" width="19"/></span></a>
            </div>
        </div>
        <form method="POST" action="<?php echo e(route('admin.option.store')); ?>" enctype='multipart/form-data' id="post_form">
            ...
            <div class="col-6">
                <div class="form-group">
                   <div>
                    ...
                    <input type="text" class="outline-0 border-bottom-blue" name="name" value="<?php echo e($obj->name); ?>">
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="outline-0 border-bottom-blue" name="display_name_en" value="<?php echo e($obj->display_name_en); ?>" />
                </div>
                <div class="form-group">
                    <div>
                        <label class="text-blue txtdemibold">Display Name (Mandarine)</label>
                    </div>
                    <input type="text" class="outline-0 border-bottom-blue" name="display_name_cn" value="<?php echo e($obj->display_name_cn); ?>" />
                </div>
                <div class="form-group">
                    <div>
                        <label class="text-blue txtdemibold">Display Name (Japanese)</label>
                    </div>
                    <input type="text" class="outline-0 border-bottom-blue" name="display_name_jp" value="<?php echo e($obj->display_name_jp); ?>" />
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-7">
                ...
                <img src="<?php echo e(asset('img/Path506.png')); ?>" class="" height="50" width="60" onclick="decNumber()" />
                <input type="number" class="numInput outline-0" name="number_selection" id="number_selection" value="<?php echo e($obj->number_selection); ?>">
                <img src="<?php echo e(asset('img/Path531.png')); ?>" class="" height="50" width="60" onclick="incNumber()">
            </div>
        ...
        <div id="content">
        <?php $__currentLoopData = $obj->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row">
                <div class="col-6">
                    <input type="text" class="outline-0 border-bottom-blue mt-2 option-name"
                        name="prev-data[<?php echo e($item->id); ?>][name]" value="<?php echo e($item->name); ?>" />
                </div>
                <div class="col-2">
                    <input type="number" class="outline-0 border-bottom-blue mt-2 option-price"
                        name="prev-data[<?php echo e($item->id); ?>][price]" value="<?php echo e($item->price); ?>" />
                </div>
                <div class="col-1">
                    ...
                    <img class="option-image" width=55 height=55
                        <?php if($obj->photo_visible == '1'): ?>
                        src="<?php echo e(asset('options/'.$item->image)); ?>"
                        <?php endif; ?>
                    >
                </div>
                <div class="col-1">
                ...
                <div class="col-1">
                    <button class="btnaddphoto3  mt-2 pt-1" type="button" onclick="onDelete(this)" data-id=<?php echo e($item->id); ?>>
                        Remove Option
                    </button>
                </div>
                <input type="file" class="file-image" name="prev-data[<?php echo e($item->id); ?>][image]" style="display:none">
                <input type="hidden" class="stock-check-value"  name="prev-data[<?php echo e($item->id); ?>][stock]">
                <input type="hidden" class="old-id" name="prev[]" value="<?php echo e($item->id); ?>">
            </div>
        ...
        <div class="row mt-5 mb-3">
            <div class="col-6">
                <button class="grey-button" type="button" onclick="onDeleteMain(this)" data-url="<?php echo e(route('admin.option.delete', ['id' => $obj->id])); ?>">DELETE
...
<script>
    ...
    function onCancel()
    {
        window.location = "<?php echo e(route('admin.option')); ?>";
    }
</script>
