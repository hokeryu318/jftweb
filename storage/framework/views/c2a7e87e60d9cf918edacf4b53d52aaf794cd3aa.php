...
<div class="col-9 pl-0">
    ...
    <form action="<?php echo e(route('admin.setting.kitchen.post')); ?>" method="POST" id="post_form">
    <div id="content">
        ...
        <div class="row ml-4 pl-2 element">
            <div class="col-9">
                <input class="card pt-2 mt-3 pl-2 font-weight-bold name" style="width:100%" value="<?php echo e($kitchen->name); ?>" name="orgitem">
            </div>
            <div class="col-3 pt-2 mt-1">
                <button type="button" class="btn black radius pt-2 pb-2 pr-4 pl-4 delete-btn" data-id="<?php echo e($kitchen->id); ?>" onclick="deleteGroup(this)">
