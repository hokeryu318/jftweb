        ...
        <div class="row">
            <div class="col-1 pr-0 pl-0 text-center">
                <div class="text-center pl-4 pt-2"style="background:#868585;">
                    <img src="<?php echo e(asset('img/arrow.png')); ?>" class="mr-4"/>
                    <p class="vericaltext text-center pt-3 mr-3 pb-3" style="height:225px">DISPLAY ALL TABLE</p>
                </div>
                <div class="text-center">
                    <img src="<?php echo e(asset('img/plus.png')); ?>" />
                    <p class="font-weight-bold pt-2">100%</p>
                    <img src="<?php echo e(asset('img/minus.png')); ?>" />
                </div>
            </div>
            <div class="col-8">
                <div style="background-image:<?php echo e(asset('img/bg1.png')); ?>;">
                    <div class="row">
                ...
                <div class="row mt-5">
                    <div class="col-2 text-center">
                        <div style="background-image:<?php echo e(asset('img/bg2.png')); ?>;background-position:center;height:150px;background-repeat:no-repeat;background-size:100%">
                ...
                <div class="row mt-5">
                    <img src="<?php echo e(asset('img/bg3.png')); ?>" class="img-fluid col-12 hight1" style="height:300px;" />
                </div>
            </div>
        </div>
        <div class="col-3">
