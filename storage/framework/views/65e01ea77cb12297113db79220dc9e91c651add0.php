...
<div class="col-9 pl-0">
    ...
    <div class="card ml-5 col-lg-5 col-8 pt-4 mr-auto pb-4 ml-auto">
        ...
        <form method="POST" action="<?php echo e(route('admin.setting.customer.save')); ?>" id="saveForm">
...
<script type="text/javascript" src="<?php echo e(asset('js/jquery.ios.picker.js')); ?>"></script>
<script>
    $('#example-picker').picker({
        data: ['Takeaway', '30min', '60min', '90min', '120min', 'Unlimited'],
        selected: <?php echo e($profile->customer); ?>,
        lineHeight: 40,
    }, function(s){
    });
    function onapply()
