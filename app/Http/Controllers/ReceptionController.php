...
//            $printer->text("----------------------------------------------\n");
            ...
            $items = array(
                new print_table1("Example item #1", "4.00"),
                new print_table1("Another thing", "3.50"),
                new print_table1("Something else", "1.00"),
                new print_table1("A final item", "4.45"),
            );
            $subtotal = new print_table1('Subtotal', '12.95');
            $tax = new print_table1('A local tax', '1.30');
            $total = new print_table1('Total', '14.25', true);
